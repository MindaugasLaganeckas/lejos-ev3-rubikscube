...
void startCameraServer() {
  ...
  config.recv_wait_timeout = 1;   // Drop if no data received in 1s
  config.send_wait_timeout = 1;   // Drop if data can't be sent in 1s
  config.task_priority = 5;      // Give the web server higher priority
  config.stack_size = 8192;      // Increase stack size for OV3660 overhead
