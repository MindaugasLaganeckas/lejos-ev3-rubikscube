...
public class RubiksCuberSolverClient {
    ...
    public RubiksCuberSolverClient() {
    ...
    public static void simpleSolve(final String scrambledCube) {
        final String result = new Search().solution(scrambledCube, 21, 100000000, 0, 0);
        System.out.println(result);
        // R2 U2 B2 L2 F2 U' L2 R2 B2 R2 D  B2 F  L' F  U2 F' R' D' L2 R'
    }

    public static void outputControl(final String scrambledCube) {
    ...
    public static String findShorterSolutions(final String scrambledCube) {
    ...
    public static void continueSearch(final String scrambledCube) {
        //Continue to find shorter solutions
        final Search searchObj = new Search();
     ...
     */
    public String solve(final String scrambledCube) {
        return findShorterSolutions(scrambledCube);
    }
}
