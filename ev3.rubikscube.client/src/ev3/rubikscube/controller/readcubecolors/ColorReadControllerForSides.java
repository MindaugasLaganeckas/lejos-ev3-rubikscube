...
public class ColorReadControllerForSides extends AbstractColorReadController {
	...
	public void colorReadCompleted(final Map<String, RubiksCubePlate> kubeColors, final ColorHitCounter colorHitCounter) {
		...
		switch (sideCode) {
		case 'B':
			kubeColors.get("R2").setColor(faceColors[1]);
			kubeColors.get("L8").setColor(faceColors[5]);
		...
		case 'U':
			...
			kubeColors.get("L4").setColor(faceColors[5]);
		...
		case 'F':
			...
			kubeColors.get("L3").setColor(faceColors[8]);
			break;
		case 'D':
			kubeColors.get("R3").setColor(faceColors[0]);
			kubeColors.get("R6").setColor(faceColors[1]);
